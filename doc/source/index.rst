...
PyAEDT-MCP is an MCP (Model Context Protocol) server for Ansys Electronics Desktop (AEDT), built using `FastMCP <https://github.com/PrefectHQ/fastmcp>`_. It provides a focused set of tools and a persistent PyAEDT-backed Python session.
...
.. grid:: 2 2 2 2
    ...
    .. grid-item-card:: :fa:`info-circle` Learn about PyAEDT-MCP
...
.. grid:: 2 2 2 2
    ...
    .. grid-item-card:: :fa:`cogs` Configure your IDE or client
        :link: getting_started/ide_configuration
        :link-type: doc

        Set up PyAEDT-MCP with Claude Code, Visual Studio Code, Claude Desktop,
